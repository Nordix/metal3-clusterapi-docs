...
bmo_pod="$(kubectl  get pods -n metal3 -o name | grep 'metal3-baremetal-operator' | cut -f2 -d'/')"
export bmo_pod
...
cd ~/go/src/sigs.k8s.io/cluster-api/cmd/clusterctl/ || exit
