...
One uses `openstack.rc` files to interact with Openstack from command line. Similarly, the controllers require some environment variables with relevant values.
...
Configuration (equivalent to the yaml format shown above):
